...
echo "INFO: Installing bash_completion for riakcli in to ${bash_completion_dir}. Make sure it is sourced using 'source  ${bash_completion_dir}/riakcli_bashcompletion' command"
